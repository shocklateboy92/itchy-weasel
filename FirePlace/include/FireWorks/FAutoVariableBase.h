...
//	std::string toString(const bool & source) { return string(); }
//	std::string toString(const int & source) { return string(); }
//	std::string toString(const double & source) { return string(); }
//	std::string toString(const unsigned char & source) { return string(); }
//	std::string toString(const char & source) { return string(); }
//	std::string toString(const unsigned short & source) { return string(); }
//	std::string toString(const short & source) { return string(); }
//	std::string toString(const unsigned int & source) { return string(); }
//	std::string toString(const float & source) { return string(); }
//	std::string toString(const std::string & source) { return string(); } // for completeness, no a-priori knowlege of what the var type is
//	std::string toString(const FAutoVariableBase &) { return string(); }
